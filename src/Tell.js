...
function Tell() {
  ...
  return (
    <div className='flex md:flex-row sm:flex-col justify-center sm:items-center md:items-start p-[80px] bg-[#faf6fb] gap-3'>
      <motion.div initial={{opacity : 0, x : -300}} animate={{opacity : view ? 1 : 0, x : view ? 0 : -300}} transition={{duration : 1}} ref={ref} className='flex flex-col mb-10'>
      ...
      <motion.div initial={{opacity : 0, x : 300}} animate={{opacity : view ? 1 : 0,  x: view ? 0 : 300}} transition={{duration: 1}} >
