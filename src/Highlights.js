...
function Highlights() {
  ...
  return (
   ...
   <motion.div  initial={{opacity : 0, y:100}} animate={{y: isview ? 0 : 100, opacity: isview ?  1 : 0}} transition={{duration:1}} className='flex flex-row md:flex-row  xl:flex-row  sm:flex-col gap-6 mt-5'>
