...
function Testimonial() {
  ...
  return !media ? (
    <motion.div  initial={{opacity : 0, y : 100}} animate={{opacity : view ? 1 : 0, y : view ? 0 : 100 }} transition={{duration : 1.1}} className='flex flex-col items-center pt-[80px] pb-[110px]'>
     ...
     <p className='text-[#7a767a] font-light text-[1.25rem] max-w-[890px] text-center'>Uniquely streamline highly efficient scenarios and 24/7 initiatives. Conveniently embrace multifunctional ideas through proactive customer service. Distinctively conceptualize 2.0 intellectual capital via user-centric partnerships.</p>
      </div>
  ...
  <p className='capitalize text-[#e38cb7]'>united states</p>
    ...
    <div  className='flex flex-col items-center pt-[80px] pb-[110px]'>
      <div ref={ref} className='text-center'>
      <p className='text-[#998a9b] text-sm font-normal'>TESTIMONIALS</p>
      <h1 className='text-[#633991] text-[33px] font-medium'>What our Customers Says</h1>
      </div>
