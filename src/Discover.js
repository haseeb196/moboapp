  ...
  return (
   <div  className='pt-[70px] pb-[70px]'>
    <div className='flex flex-col items-start justify-start  sm:mx-[40px] md:mx-[74.5px] px-[15px]'>
      <motion.div initial={{x: 400, opacity : 0}} animate={{x: view ? 0 : 400, opacity: view ? 1 : 0}} transition={{duration: 1.1}} className='flex flex-wrap  flex-col items-start md:ml-[0%] xl:ml-[50%] px-6 sm:mb-[20px] md:mb-[150px]'>
   ...
   <motion.img initial={{y: 300, opacity : 0}} animate={{y: view ? 0 : 300, opacity: view ? 1 : 0}} transition={{duration: 1.1}} className='sm:mt-[-40px] md:mt-[-200px]' src="https://preview.colorlib.com/theme/mobapp/images/perspective.png.webp" alt="phone" />
     </div>
    </div>
    </div>
  )
